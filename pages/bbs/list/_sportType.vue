      ...
      <ul>
        <li v-for="(bbs,i) in bbsList" :key="i">
          <div class="bbs-list-l">
            <img v-if="i === 0" src="http://aloss.hotforest.cn/web/zhiding.png" alt="">
            ...
            <div class="bbs-list-l-d">
              ...
              <ul>
                ...
                <li>
                  <img src="http://aloss.hotforest.cn/web/news-comment.png" alt="">
                </li>
                <li>
                  {{bbs.likes_count}}
                </li>
                <li>
                  <img src="http://aloss.hotforest.cn/web/news-like.png" alt="">
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="news-detail-rec">
      <div class="news-detail-rec-container">
        <div class="hot-news-list-t">
          ...
          <span>你可能感兴趣的</span>
          <a href="#">
            <img style="width: 20px;height: 20px;margin-right: 12px;" src="http://aloss.hotforest.cn/web/xuanzhuan.png" alt="">
            换一换
          </a>
      ...
      <div class="bbs-r-container">
        ...
        <ul>
          <li v-for="(hotBbs,i) in hotBbsList" :key="i">
            <nuxt-link  :to="{name:'bbs-detail-articleId',params:{'articleId':hotBbs.article_id}}"  target="_blank">{{hotBbs.title}}
            </nuxt-link>
