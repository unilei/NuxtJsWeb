        ...
        <div class="news-list">
            <ul>
                <li v-for="(news,index) in newsList" :key="index">
                    ...
                    <div class="news-l-r">
                        <h3>
                            <nuxt-link :to="'/news/detail?shorturl='+news.shorturl" target="_blank">
                                {{news.title}}
                            </nuxt-link>
                        </h3>
                        ...
                        <div class="news-list-d">
                            <span>{{news.timestamp | dateForHour}}</span>
                ...
                <ul>
                    <li v-for="(hotNews,index) in hotNewsList" :key="index">
                        ...
                        <div class="hot-news-list-d-r">
                            <nuxt-link :to="'/news/detail?shorturl='+hotNews.shorturl" target="_blank">
                                {{hotNews.title}}
                            </nuxt-link>
                        </div>
                    </li>
...
<script>
    // import '../../utils/api/news'
    // import '../../utils/api/like'
    ...
    export default {
        ...
        head(){
          if (this.league_value === '' || this.league_value === undefined){
            this.title = '体育新闻_体育快讯_体育最新资讯-全名体育'
            this.keywords = '体育,新闻,体育新闻,体育快讯,体育资讯,体坛最新快讯'
            this.description = '全名体育提供全面专业的体育新闻和赛事报道，主要栏目有：英超，西甲，意甲，德甲，欧冠，中超，NBA，CBA，世界杯等，让球迷及时准确的了解赛事进展和结果。'
          }
          if (this.league_value === 'nba'){
            this.title = 'NBA_NBA新闻_NBA快讯-全名体育'
            this.keywords = 'NBA,NBA新闻,NBA快讯,NBA资讯,NBA最新快讯, NBA常规赛,NBA总决赛,NBA季后赛'
            this.description = '全名体育拥有NBA常规赛、NBA总决赛、NBA季后赛等最新NBA快讯、NBA赛程、NBA球员球队的NBA数据以及丰富的NBA知识。想看NBA资讯，就上全名体育吧。'
          }
          if (this.league_value === 'premier'){
            this.title = '英超_英超新闻_英超快讯-全名体育'
            this.keywords = '英超,英超新闻,英超联赛,英超快讯,曼联,切尔西,阿森纳,利物浦,曼城,鲁尼,阿圭罗,阿扎尔,席尔瓦,穆里尼奥,范加尔,温格'
            this.description = '全名体育提供最全面的英超新闻资讯，全面及时报道英超联赛,曼联,曼城,阿森纳,利物浦,切尔西等球队最新动态。'
          }
          if (this.league_value === 'serie_a'){
            this.title = '意甲_意甲新闻_意甲快讯-全名体育'
            this.keywords = '意甲新闻,意甲最新新闻,意甲快讯,意甲资讯'
            this.description = '全名体育提供意甲联赛精彩的新闻报道，全面的意甲新闻，权威的足球评论，搭配人性化又时尚的操作介面，让球迷及时准确的了解赛事进展和结果。'
          }
          if (this.league_value === 'la_liga'){
            this.title = '西甲_西甲新闻_西甲快讯-全名体育'
            this.keywords = '西甲,西甲新闻,西甲最新新闻,西甲快讯,西甲资讯,皇马,皇家马德里,巴萨,巴塞罗那,马竞,马德里竞技,梅西'
            this.description = '全名体育提供西甲联赛精彩的新闻报道，全面及时报道西甲联赛，皇马，皇家马德里，巴萨，巴塞罗那，马竞，马德里竞技，梅西，苏亚雷斯，贝尔，库蒂尼奥，登贝莱，拉莫斯，皮克，伊斯科，阿森西奥等球员球队的比赛数据。'
          }
        ...
        async asyncData(context){
          ...
          // console.log(context.query.offset)
          let offset = 0
          let league_value = context.query.league

          let news_params = {}
          // 根据新闻类型 获取新闻列表
          if (league_value === '' || league_value === undefined){
            news_params = {
              articleType: 2,
              offset: offset,
              limit: 6
        ...
        methods: {
            ...
            //     }
            //     this.$api.like.doLike(params, headers).then(
            //         res => {
            //             console.log(res)
            ...
            showMoreNews(i) {
                //下面这个很重要 记住哟
                this.offset = i + 6
                const league_value = this.$route.query.league
        ...
        watch: {
            $route(to, from) {
              // console.log(to)
              this.league_value = to.query.league

            }

        },
        mounted() {
          this.league_value = this.$route.query.league
